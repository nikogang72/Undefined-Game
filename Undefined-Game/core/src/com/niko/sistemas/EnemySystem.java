...
public class EnemySystem extends EntitySystem implements EntityListener {
	...
	public void update(float delta)
	{
		...
		{
			ModelComponent enemyModel = e.getComponent(ModelComponent.class);
			...
			enemyPosition = enemyModel.instance.transform.getTranslation(enemyPosition);
			...
			// Walk
			cm.get(e).characterDirection.set(-1, 0, 0).rot(enemyModel.instance.transform);
			...
			enemyModel.instance.transform.set(translation.x, translation.y, translation.z, rot.x, rot.y, rot.z, rot.w);
